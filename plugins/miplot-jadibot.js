...
let handler = async (m, { conn, args, usedPrefix, command, isOwner }) => {
  let parentw = conn
  if (conn.user.jid !== global.conn.user.jid) return parentw.reply(m.chat, '┊↳🎖️┊ Este comando solo puede ser usado en el bot principal! wa.me/' + global.conn.user.jid.split`@`[0], m)
...
async function connectionUpdate(update) {
    ...
    console.log(await creloadHandler(true).catch(console.error))}
        ...
        parentw.sendMessage(m.chat, {text : "┊↳🎖️┊ La conexión se cerró, Tendras que conectarte manualmente..."}, { quoted: m })
    }
    ...
    conn.isInit = true
    global.conns.push(conn)
    await parentw.sendMessage(m.chat, {text : args[0] ? "┊↳🎖️┊ Conectado con éxito ✅" : "*Conectado con éxito✅* En unos segundos te mandaremos el Id que debes usar para volver a conectarte...  Mandalo al privado del bot cuando se desconecte."}, { quoted: m })
    await sleep(5000)
...
conn.welcome = '*┊↳🎖️┊ 𝐇𝐨𝐥𝐚 𝐁𝐢𝐞𝐧𝐯𝐞𝐧𝐢𝐝𝐨/𝐚 𝐚𝐥 𝐠𝐫𝐮𝐩𝐨!!*\n*━━━━━━━━━━━━━━━━*\n\n👤 *• 𝐍𝐨𝐦𝐛𝐫𝐞:* @user\n📝 *• 𝐃𝐞𝐬𝐜𝐫𝐢𝐩𝐜𝐢𝐨𝐧:* \n\n• ❝@desc❞\n\n🥀 *𝐃𝐢𝐬𝐟𝐫𝐮𝐭𝐚 𝐭𝐮 𝐞𝐬𝐭𝐚𝐝í𝐚 𝐞𝐧 𝐞𝐥 𝐠𝐫𝐮𝐩𝐨.*'
conn.bye = '*★════◈◈◈════★*\n┃• 𝐀𝐝𝐢𝐨𝐬👋 *@user*\n┃• 𝐕𝐞𝐭𝐞 𝐩𝐨𝐫 𝐥𝐚 𝐬𝐨𝐦𝐛𝐫𝐢𝐭𝐚 𝐗𝐃\n*★════◈◈◈════★*'
conn.spromote = '*┊↳🎖️┊ @user 𝐀𝐡𝐨𝐫𝐚 𝐞𝐫𝐞𝐬 𝐀𝐝𝐦𝐢𝐧! 👻*'
conn.sdemote = '*┊↳🎖️┊ @user 𝐘𝐚 𝐧𝐨 𝐞𝐫𝐞𝐬 𝐀𝐝𝐦𝐢𝐧 〽️*'
