...
let handler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  try {
    ...
    if (/webp|image|video/g.test(mime)) {
      ...
      if (!img) throw `*┊↳🎖️┊ 𝐑𝐞𝐬𝐩𝐨𝐧𝐝𝐞 𝐚 𝐮𝐧 𝐯𝐢𝐝𝐞𝐨, 𝐢𝐦𝐚𝐠𝐞𝐧 𝐨 𝐞𝐧𝐥𝐚𝐜𝐞 𝐝𝐞 𝐢𝐦𝐚𝐠𝐞𝐧 𝐜𝐨𝐧 𝐞𝐥 𝐜𝐨𝐦𝐚𝐧𝐝𝐨: ${usedPrefix + command}*`
      let out
      try {
      ...
      else return m.reply('*┊↳🎖️┊ 𝐄𝐧𝐥𝐚𝐜𝐞 𝐧𝐨 𝐯𝐚𝐥𝐢𝐝𝐨... 𝐏𝐫𝐨𝐜𝐮𝐫𝐚 𝐪𝐮𝐞 𝐭𝐞𝐫𝐦𝐢𝐧𝐞 𝐞𝐧 .𝐣𝐩𝐠*')
    }
  } catch (e) {
    console.error(e)
    if (!stiker) stiker = e
    ...
    else throw '*┊↳🎖️┊ 𝐄𝐧𝐥𝐚𝐜𝐞 𝐧𝐨 𝐯𝐚𝐥𝐢𝐝𝐨... 𝐏𝐫𝐨𝐜𝐮𝐫𝐚 𝐪𝐮𝐞 𝐭𝐞𝐫𝐦𝐢𝐧𝐞 𝐞𝐧 .𝐣𝐩𝐠*'
  }}
handler.help = ['sfull']
